...
ActiveRecord::Schema.define(version: 20150109172207) do
  ...
  add_index "reviews", ["city_id", "user_id"], name: "index_reviews_on_city_id_and_user_id", unique: true, using: :btree
